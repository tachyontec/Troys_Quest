...
public class ObstacleSetter {
    ...
    public void setObject() {
        ...
        gamePanel.obstacles.add( new Obstacle(15 * gamePanel.tileSize, 9 * gamePanel.tileSize, 0, 0, gamePanel.tileSize, 15, "Arrow",0,gamePanel));
        ...
        gamePanel.obstacles.add(new Obstacle(15*gamePanel.tileSize,3*gamePanel.tileSize , 3, 4, gamePanel.tileSize , gamePanel.tileSize,"spikesRoller",5,gamePanel));
