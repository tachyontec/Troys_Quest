...
public class Bird extends GameObject {
    ...
    public Bird(double worldX, double worldY, double speedx, double speedy,
                int width, int height, GamePanel gamePanel, String name) {
    ...
    public void render(Graphics2D g) {
        ...
        switch (direction) {
            ...
            case RIGHT -> rightanimation.drawAnimation(g, (int) screenX, (int) screenY,
                    gamePanel.tileSize, gamePanel.tileSize);
        }
    }
    ...
    if the collide the bird changes direction,animation */
