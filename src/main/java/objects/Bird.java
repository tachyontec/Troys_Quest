...
public class Bird extends MovingObject {
    ...
    public void render(Graphics2D g) {
        ...
        switch (direction) {
            case LEFT -> leftanimation.drawAnimation(g, (int) screenX, (int) screenY, GamePanel.TILE_SIZE, GamePanel.TILE_SIZE);
            case RIGHT -> rightanimation.drawAnimation(g, (int) screenX, (int) screenY, GamePanel.TILE_SIZE, GamePanel.TILE_SIZE);
